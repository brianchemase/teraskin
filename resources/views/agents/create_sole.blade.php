      ...
      <form class="js-step-form py-md-5" data-hs-step-form-options='{
        ...
        <div class="row justify-content-lg-center">
          <div class="col-lg-12">
            ...
            <li class="step-item">
              <a class="step-content-wrapper" href="javascript:;" data-hs-step-form-next-options='{
                    "targetSelector": "#personalDoc"
                  }'>
                <span class="step-icon step-icon-soft-dark">3</span>
                <div class="step-content">
                  <span class="step-title">Personal Documents</span>
                </div>
              </a>
            </li>
            ...
            <li class="step-item">
              <a class="step-content-wrapper" href="javascript:;" data-hs-step-form-next-options='{
                    "targetSelector": "#addUserStepBusinessUpload"
                  }'>
                <span class="step-icon step-icon-soft-dark">4</span>
                <div class="step-content">
                  <span class="step-title">Business <br> Documents</span>
                </div>
              </a>
            </li>
          </ul>
                ...
                <div id="addUserStepProfile" class="card card-lg active">
                  ...
                  <div class="card-body">
                    ...
                    <div class=" row">
                      ...
                      <div class="col-lg-6">
                        <div class="">
                          <label class="col-form-label form-label" for="exampleFormControlTextarea1">Residential Address</label>
                    ...
                    <div class="col-lg-6">
                      <label for="locationLabel" class="col-form-label form-label">Means of Number</label>
                      <div class=" ">
                        <input type="text" class="form-control" name="docNum" id="ducNum"
                  ...
                  <div class="card-footer d-flex justify-content-between align-items-center">
                    <!-- <div>
                      <a href="./corporate.html">Sign up as cooperate Agent
...
"targetSelector": "#addUserStepProfile"
                ...
                <div id="personalDoc" class="card card-lg" style="display: none">
                  <!-- Body -->
                  <div class="card-body">
                    <div class="mb-5">
                      <h2 class="display-5">Upload personal documents</h2>
                    </div>
                    <!-- Form -->
                    <div class="row">
                      <div class="col-lg-12">
                        <label for="addressLine1Label" class="col-form-label form-label">Upload Valid Means ID
                        </label>
...
"targetSelector": "#addUserStepBillingAddress"
                ...
                <div id="addUserStepBusinessUpload" class="card card-lg" style="display: none">
                  <!-- Body -->
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        <label for="addressLine1Label" class="col-form-label form-label">Upload Business Registration Certificate
                        </label>

                        <div class="">
                          <input type="file" class="form-control" name="busCert" id="busCert" />
                        </div>
                      </div>

                      <div class="col-lg-12">
                        <label for="addressLine1Label" class="col-form-label form-label">Upload copy of Form 2
                          (showing name(s) of Proprietors/Partner)
                        </label>

                        <div class="">
                          <input type="file" class="form-control" name="formProPart" id="formProPart" />
                        </div>
                      </div>
