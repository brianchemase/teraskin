          ...
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                ...
                <li class="breadcrumb-item">
                  <a class="breadcrumb-link" href="javascript:;">Agents</a>
                </li>
                <!-- <li class="breadcrumb-item active" aria-current="page">Overview</li> -->
              </ol>
            </nav>

            <h1 class="page-header-title">Agents</h1>
          </div>
          <!-- End Col -->

          <div class="col-sm-auto">
            <a class="btn btn-primary" href="/add-agent">
              <i class="bi-person-plus-fill me-1"></i> Add Agent
            </a>
          </div>
          <!-- End Col -->
        </div>
          ...
          <div class="mb-2 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Search agents"
            ...
            <tbody>
              <tr>
                ...
                <td class="table-column-ps-0">
                  <a class="d-flex align-items-center" href="agent.html">
                ...
                <td>
                  ...
                  <div class="dropdown nav-scroller-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end mt-1" style="position: fixed;" aria-labelledby="profileDropdown">
                      ...
                      <a class="dropdown-item" href="wallet-transaction.html">
                      ...
                      <a class="dropdown-item" href="transaction-rate.html">
                        <i class="bi-bar-chart dropdown-item-icon"></i>Transaction Rate
                      </a>

                      <a class="dropdown-item" href="edit-agent.html">
                        <i class="bi-pencil-square dropdown-item-icon"></i>Edit Agent Details
                      </a>

                      <a class="dropdown-item" href="reset-agent-password.html">
                ...
                <td>
                  ...
                  <div class="dropdown nav-scroller-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="profileDropdown">
                      ...
                      <a class="dropdown-item" href="edit-agent.html">
                        <i class="bi-pencil-square dropdown-item-icon"></i>Edit Agent
                      </a>
              ...
              <tr>
                ...
                <td>
                  <span class="legend-indicator bg-danger"></span>Deactivated
                </td>
                <td>
                  34747638H78
                </td>
                ...
                <td>
                  ...
                  <div class="dropdown nav-scroller-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="profileDropdown">
                      ...
                      <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#activateAgentModal">
                        <i class="bi-check-circle dropdown-item-icon"></i>Activate Agent
                      </a>
                      <a class="dropdown-item" href="#">
                        <i class="bi-list-ul dropdown-item-icon"></i> Wallet History
                      </a>
              ...
              <tr>
                ...
                <td class="table-column-ps-0">
                  <a class="d-flex align-items-center" href="agent.html">
                    ...
                    <div class="ms-3">
                      <span class="d-block h5 text-inherit mb-0">Celina Thoms</span>
                    </div>
                  </a>
                </td>
                <td>
                ...
                <td>
                  <span class="d-block fs-5 text-body">thomas@site.com</span>
